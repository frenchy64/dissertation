...
\begin{mathpar}
  ...
  \begin{array}{lllll}
    ...
    \begin{array}{llll}
      \textsf{if } \neg \shouldmergeOp{}(\atenv{}, \ova{\textsf{resolve}(\alias{})}) \textsf{ then } \atenv{}\\
...
\end{mathpar}
\caption{Definition of $\squashlocal{}(\atenv{}) = \atenv{}$
...
\begin{figure*}
  \begin{mathpar}
    ...
    \end{array}
  \end{mathpar}
  \caption{Alias merging conditions, and helpers. $\t{}(\ova{\s{}})$ deconstructs \t{} such that \ova{\s{}} are the types
  that occur syntactically in \t{}.
  }
