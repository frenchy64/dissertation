...
\begin{mathpar}
  ...
  \end{array}
\end{mathpar}
\caption{Definition of \inferupdatenoalign{\atenv{}}{\inferpath{}}{\tau}{\atenv{}}}
...
\begin{mathpar}
  \begin{array}{lllll}
    ...
    \joinalign{(\cup\ \overrightarrow{\tau_1})}{\tau}{(\cup\ \overrightarrow{\sigma})}
                                                    & \text{where }
                                                    \overrightarrow{\joinnoalign{\tau_1}{\tau}{\sigma}}
    \\
    \joinalign{\tau}{(\cup\ \overrightarrow{\tau_1})}{(\cup\ \overrightarrow{\sigma})}
                                                    & \text{where }
                                                    \overrightarrow{\joinnoalign{\tau_1}{\tau}{\sigma}}
    \\
