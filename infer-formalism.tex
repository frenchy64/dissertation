...
%
  ...
  \begin{array}{lllll}
    ...
    \generatetenv{} (\res{}) = \textsf{fold}(\inferupdateOp{}, \atenv{0}, \res{})\\
  \end{array}
  \begin{array}{lllll}
    \inferupdateOp : \atenv{}, \resentry{\inferpath{}}{\t{}} \rightarrow  \atenv{} 
    \\
    \inferupdatealign{\atenv{}}{\appendone{\inferpath{}}{\inferkeype{\{\ova{\kwp{}\ \s{}} \}}{\kw{}}}}{\t{}}
            {\inferupdate{\atenv{}}{\inferpath{}}{\{\ova{\kwp{}\ \s{}}\ \kw{}\ \t{} \}}}
    \\
    ...
    \inferupdatealign{\atenv{}}{\appendone{\inferpath{}}{\rngpe{}}}{\t{}}
                {\inferupdate{\atenv{}}{\inferpath{}}{\arrow{\UnknownT{}}{\t{}}}}
    \\
    \inferupdatealign{\updatemap{\atenv{}}{\x{}}{\s{}}}{[x]}{\t{}}
                     {\updatemap{\atenv{}}
                                {\x{}}
                                {\joinexpression{\t{}}{\s{}}}
                                 }
    \\
    \inferupdatealign{\atenv{}}{[\xvar{}]}{\t{}}{\updatemap{\atenv{}}{\x{}}{\t{}}}
    \\
  \end{array}
...
\begin{mathpar}
  \begin{array}{lllll}
    ...
    \aliashmap{}(\atenv{0}, \HMaptwo{\HMapreq{1}}{\HMapreq{2}}) = \textsf{res}\\
    \begin{array}{lllll}
      \text{where}
        &\textsf{f} : (\atenv{}, \HMapreq{}), (\kw{}, \t{}) \rightarrow (\atenv{}, \HMapreq{})\\
        &\textsf{f}((\atenv{}, \HMapreq{}), (\kw{}, \s{})) = (\atenvp{}, \updatemap{\HMapreq{}}{\kw{}}{\t{}})\\
        &\begin{array}{lllll}
          &\text{where} (\atenvp{}, \t{}) = \aliashmap{}(\atenv{}, \s{})
        \end{array}\\
        &\ova{(\atenv{i}, \HMapreqp{i}) = \textsf{fold}(\textsf{f}, (\atenv{i-1}, []), \HMapreq{i})}\\
        &\alias{} = freshAlias(\atenv{2})\\
        &\textsf{res} = (\updatemap{\atenv{2}}{\alias{}}{\HMaptwo{\HMapreqp{1}}{\HMapreqp{2}}}, \alias{})
    \end{array}
  \end{array}
  \begin{array}{lllll}
    \aliashmap{}(\atenv{0}, \arrow{\t{1}}{\t{2}}) = (\atenv{2}, \arrow{\s{1}}{\s{2}})\\
    \begin{array}{lllll}
      \text{where}
        &\ova{(\atenv{i}, \s{i}) = \aliashmap{}(\atenv{i-1},  \t{i})}
    \end{array}
    \\
    \aliashmap{}(\atenv{0}, \Unionsplice{\ova{\t{}}^n}) = \\
      \begin{array}{@{}lllll}
         &\textsf{if } \ova{\textsf{simple?}(\s{i})} \textsf{, then } (\atenv{n}, \Unionsplice{\ova{\s{}}}) \text{,}\\
         &\textsf{else } (\updatemap{\atenv{n}}{\alias{}}{\Unionsplice{\ova{\textsf{resolveTopLevel}(\s{i})}}}, \alias{})\\
         &\begin{array}{@{}llll}
           \text{where} &\ova{(\atenv{i}, \s{i}) = \aliashmap{}(\atenv{i-1}, \t{i})}\\
                        &\alias{} = freshAlias(\atenv{n})\\
          \end{array}
       \end{array}
    \\
    \aliashmap{}(\atenv{}, \t{}) = (\atenv{}, \t{}), \text{ otherwise}
  \end{array}
  ...
  \begin{array}{lllll}
    ...
    \begin{array}{llll}
      &\textsf{if } \shouldmergeOp{}(\atenv{}, \alias{1}, \alias{2})\\
      &\textsf {then } \updatemap{\updatemap{\atenv{}}{\alias{2}}{\alias{1}}}
                                 {\alias{1}}
        ...
        \begin{array}{llll}
          ...
          \begin{array}{lllll}
            ...
            \begin{array}{@{}llll}
              ...
              &\begin{array}{@{}llll}
                \atenvp{} = 
                &\textsf{if } \alias{} \in \textsf{d} \textsf{, then } \atenv{} \text{,}\\
...
\begin{figure*}
  \begin{mathpar}
    \begin{array}{lllll}
      \shouldmergeOp{} : \atenv{}, \alias{}, \alias{} \rightarrow \textbf{Bool}\\
      \shouldmergeOp{}(\atenv{}, \alias{1}, \alias{2}) =
      \\
      \begin{array}{lllll}
        \text{match } \ova{\atenv{}[\alias{i}]}  \text{ with}\\
        \begin{array}{lllll}
          \ova{\HMaptwo{\HMapreq{i}}{\HMapopt{i}}} &\rightarrow \\
          \textsf{\_} &\rightarrow \textbf{F}
        \end{array}
      \end{array}
    \end{array}
  \end{mathpar}
  \caption{Alias merging conditions
  }
  \label{infer:fig:aliasmerge}
\end{figure*}
