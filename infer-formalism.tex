...
%
  ...
  \begin{array}{lllll}
    ...
    \generatetenv{} (\ova{\resentry{\inferpath{}}{\t{}}}^n) = \atenv{n}\\
      \begin{array}{llll}
        \text{where }\\
          \begin{array}{@{}lll}
            &\atenv{0} = \emptyatenv{}\\
            &\ova{\atenv{i} = \inferupdate{\atenv{i-1}}{\inferpath{i}}{\t{i}}}
          \end{array}
        \end{array}
  \end{array}
  \begin{array}{lllll}
...
\begin{mathpar}
  \begin{array}{lllll}
    ...
    \begin{array}{llll}
      &\textsf{if } relatedByDeepKeyset(\atenv{}, \alias{1}, \alias{2})\\
    ...
    \begin{array}{lllll}
      \text{where}\\
                    \steptwohelper{} (\atenv{}, \hastype{\x{}}{\t{}}) = \replacefor{\atenv{2}}{\t{2}}{\x{}}\\
                    \begin{array}{lllll}
                      \text{where}
  ...
  \begin{array}{llll}
    ...
    \squashall{}(\atenv{}, \t{}) = \\
    \begin{array}{lllll}
      \textsf{fold}(\lambda (\atenv{}, \alias{}). \squash{}(\atenv{}, [\alias{}], []), \atenv{}, \aliasesin{}(\t{}))\\
      \begin{array}{@{}llll}
        \text{where}\\
        \begin{array}{llll}
