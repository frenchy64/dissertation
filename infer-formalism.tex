  ...
  \begin{array}{lllll}
    ...
    \begin{array}{lllll}
      \text{ where }
          ...
          &\mathsf{com}  &= \bigcap \overrightarrow{dom({\HMapreq{i}})} \\
          &\mathsf{swp}  &= \mathsf{req} \setminus \mathsf{com}\\
          &\mathsf{opt}' &= \bigcup \overrightarrow{dom({\HMapopt{i}})} \cup \mathsf{swp} \\
          &\mathsf{req}' &= \mathsf{com} \setminus \mathsf{opt}' \\
