...
%\subtitle{A Semi-Automatic Workflow to Type Annotate Programs that use Ad-Hoc Data Structures}
%\subtitle{Semi-Automatic Type Annotations for Ad-Hoc Data Representations}
\subtitle{A Workflow for Typing Untyped Programs that use Ad-Hoc Data Structures}
