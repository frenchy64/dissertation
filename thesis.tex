\documentclass[11pt,reqno,draft]{iuthesis}
%\documentclass[11pt,reqno,final]{iuthesis}

\newcommand{\DISSERTATION}{}

\usepackage{setspace} % allows toggling of double/single-spacing
\doublespacing %\singlespacing % sets default spacing; also: \doublespacing & \onehalfspacing
...
\chapter{Automatic Annotations for Typed Clojure}
