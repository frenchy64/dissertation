...
\usepackage[final]{pdfpages} % to insert cv
...
% make chapter headers 12pt 
\newcommand\chapterfontsize{12pt}

\makeatletter
\patchcmd{\@makechapterhead}
 {\fontsize{\@xivpt}{18}}
 {\fontsize{\chapterfontsize}{\chapterfontsize}}
 {}{}
...
% make footnotes 11pt (don't know how to make it 10pt, would rather that)
\makeatletter
