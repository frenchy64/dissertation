...
its tracking is not realized.
Also, the first argument of \clj{visit-leaf} takes something more specific than an \clj{Op}.
Any of these imprecisions could trigger a type error from Typed Clojure on usages of \clj{visit-leaf},
and then manual intervention is needed (highlighted). We factor out and use a new alias \clj{Leaf}
