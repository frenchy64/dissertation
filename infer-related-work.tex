...
respectively, using static analysis.
We were unable to install TSInfer.
Out of the box, Pytype inferred \texttt{nodes} (\figref{fig:infer:nodes})
as \texttt{(? -> int)} and
its class-based translation typed fields
\texttt{left}, \texttt{right}, and
\texttt{val} as \texttt{Any}, and method
