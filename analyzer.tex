...
$$
  \begin{array}{r||l|l|l|l|}
    ...
    \hline
     ...
     1             & \text{\clj{unanalyzed-top-level}} &                                 & &\\
     2             & \text{\clj{analyze-outer}}^{*}    &                                 & &\\
     3             & \text{\clj{run-pre-passes}}^{>}   &                                 & &\\
     4             & \text{\clj{check}}^{>}            &                                 & &\\
     5             &                                   & \text{\clj{analyze-outer}}^{*}  & &                            \\
     6             &                                   & \text{\clj{run-pre-passes}}^{>} & &                            \\
     7             &                                   & \text{\clj{check}}^{>}          & &                            \\
     8             &                                   & \text{\clj{run-post-passes}}^{<}& &                            \\
     9             &                                   & \text{\clj{check}}^{<}          & &                            \\
     10            &                                   & \text{\clj{eval-top-level}}     & &                       \\
     11            &                                   & & \text{\clj{analyze-outer}}^{*}    &                           \\
     12            &                                   & & \text{\clj{run-pre-passes}}^{>}   &                           \\
     13            &                                   & & \text{\clj{check}}^{>}            &                           \\
     14            &                                   & & \text{\clj{run-post-passes}}^{<}  &                           \\
     15            &                                   & & \text{\clj{check}}^{<}            &                           \\
     16            &                                   & & \text{\clj{eval-top-level}}       &                      \\
     17            &                                   & & & \text{\clj{analyze-outer}}^{*}                               \\
     18           &                                   & & & \text{\clj{run-pre-passes}}^{>}                              \\
     19           &                                   & & & \text{\clj{check}}^{>}                                       \\
     20           &                                   & & & \text{\clj{run-post-passes}}^{<}                             \\
     21           &                                   & & & \text{\clj{check}}^{<}                                       \\
     22           &                                   & & & \text{\clj{eval-top-level}}                             \\
     23           & \text{\clj{run-post-passes}}^{<}      &                               & \\
     24           & \text{\clj{check}}^{<}            &                               & \\
     25           & \text{\clj{eval-top-level}}^{<}   &                               & \\
  \end{array}
$$
%\begin{verbatim}
