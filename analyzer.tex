...
are otherwise brilliant and innovative, and is a great base to build a new analyzer better suited to help solve
...
several passes.
Intermediate rep not possible due to multi passes
Third, 

\texttt{tools.analyzer} was designed to be a 
front-end for the \texttt{tools.emitter} compiler, and so 

This chapter presents a revised design which is more flexible
by supporting \emph{interleaving} of expansion and checking.
