...
reload expressions out-of-order as evidence 
to change the expansion order of inner forms.
...
between code on disk with code loaded into memory.
A cottage industry of Clojure libraries and conventions has arisen to
help manage these situations, with Clojure providing no centralized solution.
On the other hand, this problem is recognized and addressed by Racket's module system.
At the very least, these complications justify our reluctance to
change the expansion order of Clojure code and encourage us to
tread carefully.
