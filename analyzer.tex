...
starting from \clj{f}, whereas the evaluation order of elements of unordered set literals \clj{#\{k*\}}
is not addressed.
On the other hand, order of \emph{expansion} is not addressed at all, usually a sign
...
This is convenient for us (and perhaps shows our biases)
since not having to micromanage the order of expansion
makes writing custom typing rules and other Typed Clojure
