...
(ann nodes [Tree -> Int])
\end{cljlisting}
Existing approaches to automatically annotations
cannot usefully annotate these kinds of programs, since
they usually rely on the existence of named classes.
Recursive types are naturally inferred from local class invariants,
...
cannot infer recursive types for plain data,
