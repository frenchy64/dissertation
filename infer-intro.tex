...
Maps in Clojure also replace records or objects in many situations.
...
Porting this program to Typed Clojure involves writing a type definition
...
\end{lstlisting}
the annotation for \figref{fig:infer:nodes} is still not recursive (alarmingly, it instead
