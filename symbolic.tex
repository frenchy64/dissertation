...
Here, we explain the syntax and rules for the original internal language,
and then extend it to allow unannotated functions and symbolic closure
types.
In \chapref{chapter:symbolic:directed-lti}
we present the external language, and our corresponding extensions,
which compiles to the internal language using local type argument inference.
...
that bind type variables \ova{\ltitvar{}},
function application
\ltiappinst{\ltiF{}}{\ova{\ltiT{}}}{\ltiE{}}
with explicit type arguments {\ova{\ltiT{}}},
record selectors
\ltisel{\ltiE{}}{\ltivar{}},
