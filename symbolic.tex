  ...
  \begin{mathpar}
    ...
    \ltiunfold{\ltiT{}^f}
              {\ltiPoly{\ova{\ltitvar{}}}
                  ...
                  \\\\
                  \exists i \in 1...m.
                        \ltiunifyContextsSC{\ltiCombinedThreadedEnvp{0}}
                                           {\ltistackmapping{\ltiEnv{i}}{\ova{\ltiRp{}}_i}}
                                           {\ltiEnvp{}}
                                           {\ova{\ltiR{}}}
                                           {\ltiCombinedThreadedEnvp{1}}
    \\
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}-1}
                      ...
                      {\ltiFpp{}}
                      \\\\
    \ltiupdateClosureCache{\ltiClosureCachep{}}{\ltiEnv{}}{\ltiClosureID{}}{\varnothing}{\ltiTp{}}{\ltiS{}}{\ltiFpp{}}{\ltiClosureCachepp{}}
    }
    {
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                      {\ltiEnv{}}
...
\begin{figure}
  ...
  \end{array}
    ...
    \\\\
    \text{Record closure \ltiClosureID{} as \ltiPoly{\ova{\ltitvar{}}}{\ltiFn{\ltiT{}}{\ltiS{}}} under}
    \\\\
