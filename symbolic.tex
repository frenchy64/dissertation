...
\begin{array}{lrll}
  \ltiE{}, \ltiF{} &::=& ... \alt
                         \ltiufunelab{\ova{\ltiufunelabentry{\ltiClosureID{}}}}
                                     ...
                                     {\ltiE{}}
                      &\mbox{Terms} \\
  \ltiapp{\ltiE{}}{\ltiF{}} &\Leftrightarrow& \ltiappinst{\ltiE{}}{}{\ltiF{}}
  \\
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \\
    \overrightarrow{
    \ltilookup{\ltiClosureCachep{}}{\ltiClosureID{i}} = 
    ...
    \\\\
    \ltiT{} = \ltiMu{\ltiClosureID{1}}{\ltireplaceova{\ltiClosureID{1}}{\ltiClosureID{i}}}
                    {\ltiSplitIFn{}{\overrightarrow
                              {\overrightarrow{\ltiContextualFn{\ltielimClosEnvLHS{\ltiClosureCache{}}{\ltiEnv{j}^i}}
                                                    {\ltielimClosTLHS{\ltiClosureID{i}}{\ltiClosureCache{}}{\ltiT{j}^i}}
                                                    {\ltielimClosTLHS{\ltiClosureID{i}}{\ltiClosureCache{}}{\ltiS{j}^i}}}}}}
    }
