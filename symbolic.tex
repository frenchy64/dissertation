...
(* fully annotated *)
Some = $\ltifuntparaminterfaceLHS{\text{t}}{\ltiFn{\text{t}}{\text{Option[t]}}}{\text{y}}$
         {match = $\ltifuntparaminterface{\text{r}}{\ltiFn{\text{OptionVisitor[t,r]}}{\text{r}}}{\text{v}}{\text{v.caseSome(y)}}$}
\end{lstlisting}
}
...
(* fully annotated *)
map = $\ltifuntparaminterfaceLHS{\text{c,d}}{\ltiFn{\ltiFn{\text{c}}{\text{d}},\text{Option[c]}}{\text{Option[d]}}}{\text{f,x}}$
        x.match[d]({caseNone = $\ltifuninterface{\ltiFn{}{\ltilstOption{\ltiBot}}}{}{\text{None()}}$,
                    caseSome = $\ltifuninterface{\ltiFn{\text{c}}{\ltilstOption{\text{d}}}}{\text{y}}{\text{Some(f(y))}}$})
