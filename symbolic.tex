...
%    }
    ...
    \ltitjudgement{\ltiEnv{}}
          ...
          \ltiisubtype{\ltiEnv{}}
                    {\ltiS{}^f}
                    {\ltiPoly{\ova{\ltitvar{}}}
                             {\ltiIFn{\ltiContextualFn{\ltiEmptyEnv}{\ltiT{}}{\ltiS{}}}}}
                  \\
                       |\ova{\ltitvar{}}|>0
                  \\\\
                  \forall \ltiRp{}.
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \ltilookup{\ltiClosureCache{}}{\ltiClosureID{i}} = 
      \ltiClosureCacheVal{\ltiSplitIFn{}
                          {\ltiContextualFn{\ltiEnv{1}^i}{\ltiT{1}^i}{\ltiS{1}^i},...,
                           \ltiContextualFn{\ltiEnv{m_i}^i}{\ltiT{m_i}^i}{\ltiS{m_i}^i}}
                          }
                         {\ltiF{i}}
                         ,\ 
    ...
    \ltiT{} =  \ltiSplitIFn{}{\overrightarrowcaption
                                {\ltiContextualFn{\ltielimClosEnvLHS{\ltiClosureCache{}}{\ltiEnv{1}^i}}
                                                 {\ltielimClosTLHS{\varnothing}{\ltiClosureCache{}}{\ltiT{1}^i}}
                                                 {\ltielimClosTLHS{\varnothing}{\ltiClosureCache{}}{\ltiS{1}^i}}
                                                 ,...,
                                \ltiContextualFn{\ltielimClosEnvLHS{\ltiClosureCache{}}{\ltiEnv{m_i}^i}}
                                                 {\ltielimClosTLHS{\varnothing}{\ltiClosureCache{}}{\ltiT{m_i}^i}}
                                                 {\ltielimClosTLHS{\varnothing}{\ltiClosureCache{}}{\ltiS{m_i}^i}}
                                                 }^{1 \leq i \leq n}
                                                 }
    }
