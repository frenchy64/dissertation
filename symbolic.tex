...
\begin{figure}
  \begin{mathpar}
    ...
    { 
    \ltiTp{} =
      \ltiPoly{\ova{\ltitvar{}}}{\ltiIFn{\ltiContextualFn{\ova{\ltiEnv{}}}{\ova{\ltiT{}}}{\ova{\ltiS{}}}}}
    \\\\
...
\begin{figure}
  ...
  \begin{array}{llll}
    \ltimergeTaggedTermsalign{\ltifuninterface{\ltiIFn{\ova{\ltiContextualFn{\ltiEnv{}}{\ltiT{}}{\ltiS{}}}^n}}{\ltivar{}}{\ltiE{1}}}
                             {\ltifuninterface{\ltiIFn{\ova{\ltiContextualFn{\ltiEnv{}}{\ltiT{}}{\ltiS{}}}^{n+1...m}}}
                                              {\ltivar{}}
                                              {\ltiE{2}}}
                             {\ltifuninterface{\ltiIFn{\ova{\ltiContextualFn{\ltiEnv{}}{\ltiT{}}{\ltiS{}}}^{m}}}
                                              {\ltivar{}}
                                              {\ltimergeTaggedTermsLHS{\ltiE{1}}{\ltiE{2}}}}
                             \\
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltiunfold{\ltiT{}^f}
           ...
           \\
           \ltiprocessDelays{\ltiCombinedThreadedEnv{3}}{\ltiCp{}}{\ltiC{}}{\ltiCombinedThreadedEnv{4}}
           \\
...
\begin{figure}
  \begin{mathpar}
    \infer[]
    {
      ...
      \\
      \forall i,j \in 1...n.
         \text{ if } \ltitv{\ltiT{i}} \cap \ltitv{\ltiS{j}} \cap \ova{\ltitvarp{}} \not= \varnothing
         \text{ then } depends(i,j) 
      \\
      \text{let \ova{k} be a permutation of 1...n such that }
        \forall i,j \in 1...n.
        depends(k_i,k_j) \text{ implies }
    ...
    \\\\
      \overrightarrowcaption{
      (\ltiC{i}, \ltimakeCombinedThreadedEnv{\ltiFuel{i}}{\ltiClosureCache{i}})
      =
      \left\{
      \begin{array}{lll}
      (\ltiC{i}, \ltimakeCombinedThreadedEnv{\ltiFuel{i}}{\ltiClosureCache{i}})
        ...
        \begin{array}{lll}
            0 < \ltiFuel{i-1}\arcr
            % TODO substitute/demote etc.
            \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{i-1}-1}
                                                          {\ltiClosureCache{i-1}}}
                              {\ltiEnvConcat{\ltiEnvMissingTVarsLHS{\ltiEnvp{}}{\ltiEnv{}}}{\hastype{\ltivar{}}{\ltiTp{}}}}
                              {\ltiEpp{}}
                              {\ltiS{}}
                              {\ltimakeCombinedThreadedEnv{\ltiFuel{i}}
                                                          {\ltiClosureCachep{i}}}
                              {\ltiFpp{}}
                              \arcr
          \ltiupdateClosureCache{\ltiClosureCachep{i}}
                                {\ltiEnv{}}
                                {\ltiClosureID{}}
                                {\ltiTp{}}
                                {\ltiS{}}
    ...
    {
      \ltiprocessDelays{\ltimakeCombinedThreadedEnv{\ltiFuel{0}}{\ltiClosureCache{0}}}
                       {\ltiC{0}}
                       {\ltiC{}}
