...
\begin{figure}
  \begin{mathpar}
    \begin{array}{rcl}
      \boxed{\ltiexpandEnclosingFn{\ltiEnclosingFnStack{}}{\ltiT{}}{\ltiT{}}}\\\\
      ...
      \ltiexpandEnclosingFnalign{\ltiEnclosingFnStack{}}
                                ...
                                &&\text{where }
                                   ...
                                   \right.
                                                \\
      \ltiexpandEnclosingFnalign{[\ltiT{1}, ..., \ltiT{i}, ..., \ltiT{n}]}
    ...
    {
    \overrightarrow{
    \ltitstkjudgement{\ltiStackConcat{\ltiIFn{\ltiFn{\ltiT{}}{\ltiS{}}}}{\ltiEnclosingFnStack{}}}
...
\begin{array}{lrll}
  ...
  \ltiFuel{} &::=& \ltinat{}
                      &\mbox{Closure Fuel} \\
  \ltiClosureCache{} &::=& \ova{\ltiClosureID{} \Rightarrow {\ltiClosureCacheVal{\ltiIFn{\ova{\ltiFn{\ltiT{}}{\ltiT{}}}}}{\ova{\ltiFl{}}}}}
                      &\mbox{Closure Cache} \\
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{i-1}}
                     {\ltiStackConcat{\ltiIFn{\ltiFn{\ltiT{i}}{\ltiS{i}}}}{\ltiEnclosingFnStack{}}}
    ...
    \ltimapsto{\ltiClosureID{}}
              {\ltiClosureCacheVal{\ltiEmptyIFn}{\varnothing}}
              {\ltiClosureCache{}}
    }
    {
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}-1}
                      ...
                      {\ltiEl{}}
                      \\\\
    \ltiClosureCacheVal{\ltiIFn{\ova{\ltiFn{\ltiTp{}}{\ltiSp{}}}}}{\ova{\ltiFl{}}} = \ltilookup{\ltiClosureID{}}{\ltiClosureCachep{}}
    \\\\
...
\begin{figure}
  ...
  \begin{array}{rll}
    ...
    \ltimergeTaggedTermsalign{\ltifuninterface{\ltiT{}}{\ltivar{}}{\ltiEl{1}}}
                             {\ltifuninterface{\ltiT{}}{\ltivar{}}{\ltiEl{2}}}
                             {\ltifuninterface{\ltiT{}}{\ltivar{}}{\ltimergeTaggedTermsLHS{\ltiEl{1}}{\ltiEl{2}}}}
                                     \\
    ...
    \ltimergeTaggedTermsalign{\ltiRec{\ova{\ltivar{} = \ltiEl{}}}}
                             {\ltiRec{\ova{\ltivar{} = \ltiElp{}}}}
                             {\ltiRec{\ova{\ltivar{} = \ltimergeTaggedTermsLHS{\ltiEl{}}{\ltiElp{}}}}}
                                     \\
                                     % no annotations inserted yet, will be identical
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    {\ltielimClos{\ltiCombinedThreadedEnv{}}
                 {\ltifuninterface{\ltiT{}}{\ltivar{}}{\ltiEl{}}}
                 {\ltifuninterface{\ltiT{}}{\ltivar{}}{\ltiE{}}}
                 }
    ...
    {\ltielimClos{\ltiCombinedThreadedEnv{}}
                 ...
                 {\ltiE{}}
                 \\\\
     \ltielimClosT{\ltiCombinedThreadedEnv{}}
                  {\ltiT{}}
                  {\ltiTp{}}
                 }
    {\ltielimClos{\ltiCombinedThreadedEnv{}}
    ...
    1 \leq i \leq n
    \\
    \ltiClosureCacheVal{\ltiT{i}}{\ova{\ltiFl{}}^{m_i}_i} = \ltilookup{\ltiClosureID{i}}{\ltiClosureCachep{}}
    \\\\
    \ltiEp{i} =  \left\{
                 \begin{array}{lll}
                   \ltiFl{0}, &\text{if } m_i=0 \arcr
                   \ltiEl{1}, &\text{if } m_i=1 \arcr
                   \ltiFl{n}, & \text{otherwise, where} \arcr
                   &\text{ } \ltimergeTaggedTerms{\ltiFl{i-1}}{\ltiEl{i}}{\ltiFl{i}}, 
                 \end{array}
                 \right.
    \\\\
    \ltielimClosT{\ltiCombinedThreadedEnv{}}{\ltiT{i}}{\ltiTp{i}}
    }
    { \ltielimClos{\ltiCombinedThreadedEnv{}}
                  {\ltiufunelab{\ova{\ltiufunelabentry{\ltiEnclosingFnStack{}}
                                                      {\ltiEnv{}}
                               ...
                               {\ltivar{}}
                               {\ltiE{}}}
                  {\ltifuninterface{\ltiIntersection{\ova{\ltiTp{}}^n}}
                                   {\ltivar{}}
                                   {\ltiEp{}}}
                  }
  ...
  \[
    \boxed{\ltielimClosT{\ltiCombinedThreadedEnv{}}{\ltiT{}}{\ltiTp{}}
