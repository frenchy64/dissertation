...
\begin{figure}
  \begin{mathpar}
    ...
    \begin{array}{rcl}
      ...
      \ltiexpandEnclosingFnalign{\ltiEnclosingFnStack{}}
                                ...
                                &&\text{where }
                                   ...
                                   \left\{
                                   \begin{array}{ll}
                                     \ltiexpandEnclosingFnLHS{\ltiEnclosingFnStack{}}{\ltiSp{i}}, & \text{if }
                                               \ltiisubtype
      ...
      %                          {\ltiIntersection{\ova{\ltiexpandEnclosingFnLHS{\ltiEnclosingFnStack{}}{\ltiT{}}}}}\\
      %\ltiexpandEnclosingFnalign{\ltiEnclosingFnStack{}}
      %                          {\ltiUnion{\ova{\ltiT{}}}}
      %                          {\ltiUnion{\ova{\ltiexpandEnclosingFnLHS{\ltiEnclosingFnStack{}}{\ltiT{}}}}}\\
      \ltiexpandEnclosingFnalign{\ltiEnclosingFnStack{}}
    ...
    {\boxed{\lticheckFn{\ltiEnclosingFnStack{}}
                ...
                is type \ltiT{} in contexts \ltiEnclosingFnStack{} and \ltiEnv{}.
                }
                }
                }
    \\
...
%                 \left\{
%                 \begin{array}{lll}
%                   \ltiFl{0}, &\text{if } n=0 \arcr
%                   \ltiEl{1}, &\text{if } n=1 \arcr
%                   \ltiFl{n}, & \text{otherwise, where} \arcr
%                   &\text{ } \ltimergeTaggedTerms{\ltiFl{i-1}}{\ltiEl{i}}{\ltiFl{i}}, 
%                 \end{array}
%                 \right.
%                 }
%    {
...
%                     {\ltifuninterface{\ltiT{}}{\ltivar{}}{\ltiFlp{}}}
%                 }
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \\\\
    \ltimergeTaggedTerms{\ltiE{i-1}}{\ltiF{i}}{\ltiE{i}}
    \\\\
    \ltielimClosT{\varnothing}{\ltiCombinedThreadedEnv{}}{\ltiT{i}}{\ltiS{i}}
    }
    { \ltielimClos{\ltiCombinedThreadedEnv{}}
                  {\ltiufunelab{\ova{\ltiufunelabentry{\ltiEnclosingFnStack{}}
                               ...
                               {\ltivar{}}
                               {\ltiE{0}}}
                  {\ltifuninterface{\ltiIntersection{\ova{\ltiS{}}^n}}
                                   {\ltivar{}}
                                   {\ltiE{n}}}
                  }

    \infer [Elab-Ann]
    {\ltielimClos{\ltiCombinedThreadedEnv{}}{\ltiE{}}{\ltiEp{}}
    \\\\
    \ltielimClosT{\varnothing}{\ltiCombinedThreadedEnv{}}{\ltiT{}}{\ltiTp{}}
    }
    {\ltielimClos{\ltiCombinedThreadedEnv{}}
                 {\ltiann{\ltiE{}}{\ltiT{}}}
                 {\ltiann{\ltiEp{}}
  ...
  % FIXME make the seen list a mapping from Closure ID's to type variables instead of using
  % an implicit gensym
  \begin{mathpar}
