...
We formalize symbolic closure types by defining separate internal and an external languages,
and providing a type inference algorithm to recover missing type annotations in the
external language.
This approach is similar to Local Type Inference~\cite{PierceLTI}
and Colored Local Type Inference~\cite{coloredlti01},
except we do not utilize bidirectional checking, and instead 

Our internal language, System \ltiFsub extended with records, is functionally identical
to that used to model Colored Local Type Inference~\cite{coloredlti01}, except
our explicitly-typed lambda terms require return type annotations.

In order to reliably elaborate to \ltiFsub, symbolic closure types must be restricted.

First, the elaborated type of a symbolic closure is chosen greedily,
when it is first symbolically executed.
...
type for a function.
If we did, each symbolic execution would then correspond to a new interface.
Adding intersection types implies further considerations, namely
...
and obscures the (orthogonal) idea of symbolic closures, which we hope to communicate
its essense.
...
Second, we disallow a symbolic closure from entering a new type-variable scope.
This raises questions about scoping also solved by
contextual subtyping~\cite{Dunfield2004Tridirectional}.
...
We must fully erase symbolic closure types to elaborate to our \ltiFsub,
however we do not model equirecursive type binders, and so there is no
obvious encoding for such a type. On the other hand, since it does not require
recursive types to elaborate, symbolic closures
be passed to \emph{other} symbolic closures, even if the former is polymorphic
(since \ltiFsub is impredicative, i.e., does not restrict the places a polymorphic type
may occur).

Fourth, we add a global symbolic reduction limit, called ``fuel'', to make
type inference decidable.

As we will see, even in this restriction, they are very helpful.
...
\begin{figure}
  ...
  \caption{External Language Specification.
      For each \ltitjudgementNoElab{\ltiEnv{}}{\ltiE{}}{\ltiT{}}
      rule in \figref{symbolic:figure:internal-language-type-system},
      includes an analogous 
      \ltitjudgement{\ltiEnv{}}{\ltiE{}}{\ltiT{}}{\ltiEp{}}
      rule, where \ltiEp{} is constructed from
      the fully typed subexpressions (when obvious).
  }
...
\begin{array}{lrll}
  ...
  \ltiClosureElab{} &::=& \ltiClosure{\ltiEnv{}}{\ltiufun{\ltivar{}}{\ltiE{}}}
                                \alt
                                \ltiClosure{\ltiEnv{}}{\ltifuntparaminterface{\ova{\ltitvar{}}}{\ltiT{}}{\ltivar{}}{\ltiE{}}}
  ...
  \ltiCombinedThreadedEnv{} &::=& \ltimakeCombinedThreadedEnv{\ltiFuel{}}{\ltiClosureCache{}}
                      &\mbox{Combined Closure Environments}
\end{array}
$$
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}}{\ltiClosureCache{}}}
                      ...
                      {\ltiEp{}}
                     \\\\
                     \text{Given fuel \ltiFuel{}, symbolic closure cache \ltiClosureCache{}
                     ...
                     \\\\
                     \text{
                     with updated fuel \ltiFuel{}, symbolic closure cache \ltiClosureCachep{},
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                      ...
                      {\ltiapp{\ltiF{}}{\ltiE{}}}
                      {\ltiS{}}
                      {\ltimakeCombinedThreadedEnv{\ltiFuel{4}}{\ltiClosureCache{5}}}
                      {\ltiappinst{\ltiFp{}}
                                  {}
                                  {\ltiEp{}}}
    }
...
%
    ...
    \infer [Abs]
    {
                     \text{$|\ova{\ltitvar{}}|>0$ implies \ltiEnv{} does not contain a symbolic closure}
                     \\\\
     \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                    {\ltiEnvConcat{\ltiEnv{}}
                                   {\ltiEnvConcat{\ova{\ltitvar{}}}
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}}{\ltiClosureCache{}}}
                      ...
                      {\ltiClosureWithStkID
                                           ...
                                           {\ltiClosureID{}}
                                           {\ltiufun{\ltivar{}}{\ltiE{}}}}
                      {\ltimakeCombinedThreadedEnv{\ltiFuel{}}{\ltiClosureCachep{}}}
...
\begin{figure}
  \begin{mathpar}
    ...
    {\ltiSsubtype{\ltimakeCombinedThreadedEnv{\ltiFuel{}}{\ltiClosureCache{}}}
                 ...
                 \\\\
                 \text{
                 With fuel \ltiFuel{} and symbolic closure cache \ltiCombinedThreadedEnv{},
                 \ltiS{} is a subtype of \ltiT{}}
                 \\\\
                 \text{
                 with updated fuel \ltiFuel{} and symbolic closure cache
    ...
    \infer [S-Poly]
    {
    |\ova{\ltitvar{}}|>0 \text{ implies \ltiT{} and \ltiS{} do not contain symbolic closures}
    \\
    \ltiSsubtype{\ltiCombinedThreadedEnv{}}
                {\ltiEnvConcat{\ltiEnv{}}{\ova{\ltitvar{}}}}
                {\ltiT{}}
    ...
    \ltiSsubtype{\ltiCombinedThreadedEnv{2}}{\ltiEnv{}}{\ltiSp{}}{\ltiS{}}
                {\ltimakeCombinedThreadedEnv{\ltiFuel{3}}{\ltiClosureCache{3}}}
                      \\
    \ltiupdateClosureCache{\ltiClosureCache{3}}{\ltiEnv{}}{\ltiClosureID{}}{\ova{\ltitvar{}}}{\ltiT{}}{\ltiS{}}{\ltiEp{}}{\ltiClosureCache{4}}
    }
...
\begin{figure}
  \begin{mathpar}
    ...
    \begin{array}{llll}
    \ltiupdateClosureCachealign{\ltiClosureCache{}}{\ltiEnvp{}}{\ltiClosureID{}}{\ova{\ltitvar{}}}{\ltiT{}}{\ltiS{}}{\ltiE{}}
                           {\ltimapsto{\ltiClosureCache{}}
                                      {\ltiClosureID{}}
                                      {\ltiClosure{\ltiEnv{}}
                                                   {\ltifuntparaminterface{\ova{\ltitvar{}}}
    ...
    \ltilookup{\ltiClosureCache{}}{\ltiClosureID{}} = 
                       {\ltiClosure{\ltiEnv{}}
                                   {\ltiufun{\ltivar{}}{\ltiF{}}}}
                                   \\
    \ltiupdateClosureCachealign{\ltiClosureCache{}}{\ltiEnvp{}}{\ltiClosureID{}}{\ova{\ltitvar{}}}{\ltiT{}}{\ltiS{}}{\ltiE{}}{\ltiClosureCache{}},
                                                                          &\text{ where }
    \ltilookup{\ltiClosureCache{}}{\ltiClosureID{}} = 
                       {\ltiClosure{\ltiEnv{}}
                                   {\ltifuntparaminterface{\ova{\ltitvar{}}}
...
\begin{figure}
  ...
  \begin{array}{llll}
    ...
    \ltielimClosTalign{\ova{\ltiClosureID{}}}{\ltiClosureCache{}}
                      {\ltiFn{\ltiT{}}{\ltiS{}}}
                      {\ltiFn{\ltielimClosTLHS{\ova{\ltiClosureID{}}}{\ltiClosureCache{}}{\ltiT{}}}
