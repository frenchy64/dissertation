...
\begin{array}{lrll}
  ...
  \ltiT{}, \ltiS{}, \ltiR{} &::=& \ltitvar{} 
                         ...
                         \alt \ltiExists{\ova{\ltitvar{}}}{\ltiT{}}
                         \alt
...
\begin{figure}
  \begin{mathpar}
    ...
    \\
    \overrightarrow{\ltiisubtype{\ltiSp{i}}{\ltiS{i}}}
    \\\\
    \overrightarrow{
    \ltitjudgement{\ltiEnvConcat{\ltiEnv{FIXME}}{\hastype{\ltivar{}}{\ltiT{j}}}}
                  {\ltiE{}}
                  {\ltiSp{j}}
                  }
    \\
    ...
    \ltitjudgement{\ltiEnv{}}
                  ...
                  {\ltiTp{}}
                  \\\\
                  \ltiresolve{\ltiEnv{}}{\ltiSpp{}}{\ltiPoly{\ova{\ltitvar{}}}{\ltiTpp{}}}
                  \\\\
                  \exists! k \in 1...m.\ 
                  \ltiunifyContexts{\ltistackmapping{\ltiEnvp{k}}{\ova{\ltiR{}}_k}}{\ltiEnv{}}
                                   {\ova{\ltiR{}}}
                  \\\\
                  \ltireplace{\ova{\ltiR{}}}{\ova{\ltitvar{}}}{\ltiTpp{}} =
                  \ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}^n}
                              {\ova{\ltiContextualFn{\ltiEnvpp{}}{\ltiRp{}}{\ltiRpp{}}}}
                  \\\\
...
\begin{figure}
  \begin{mathpar}
    ...
    \text{ Resolve top-level contextual types in \ltiT{} using \ltiEnv{}.
    }
    }
    ...
    \begin{array}{lcl}
      \ltiresolvealign{\ltiEnv{}}
                      {\ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}^n}
                                   {\ova{\ltiContextualFn{\ltiEnv{j}}{\ltiT{j}}{\ltiS{j}}}^m\ 
                                    \ova{\ltiContextualFn{\ltiEnv{k}}{\ltiT{k}}{\ltiS{k}}}^p}}
                      {\ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}\ 
                                    \ova{\ltiFn{\ltiTp{j}}{\ltiSp{j}}}}
                                   {% do we want to keep this around for further instantiations?
                                    % I think resolve is only useful for top-level things that are thrown away like App
                                   ...
                                   &&\text{ }
                                   \begin{array}{lll}
                                     1 \leq i \leq n < j \leq (n+m) < k \leq (n+m+p) \arcr
                                   ...
                                   \end{array}
                                   \\
                                   % FIXME resolving under Poly technically changes the environment ... 
      \ltiresolvealign{\ltiEnv{}}
                      {\ltiPoly{\ova{\ltitvar{}}}{\ltiT{}}}
                      {\ltiPoly{\ova{\ltitvar{}}}{\ltiresolveLHS{\ltiEnv{}}{\ltiT{}}}}\\
      \ltiresolvealign{\ltiEnv{}}
                      {\ltiMu{\ltitvar{}}{\ltiT{}}}
                      {\ltireplace{\ltiMu{\ltitvar{}}{\ltiT{}}}{\ltitvar{}}{\ltiresolveLHS{\ltiEnv{}}{\ltiT{}}}}\\
...
\begin{figure}
  \begin{mathpar}
    ...
    {
    i \in 1 ... n \\
    % because we use the same tau symbol in i's and j's
    j \in n+1\ ...\ n+m
    \\\\
    ...
    \overrightarrow{
     \ltitSdjudgement{\ltiEnvConcat{\ltiEnv{}}
                     ...
                     \\\\
    \overrightarrow{
     \ltitSdjudgement{\ltiEnvConcat{\ltiEnvMissingTVarsLHS{\ltiEnv{}}{\ltiEnv{j}}}
                                   {\ltiEnvConcat{\ova{\ltitvar{}}}
                                                 {\hastype{\ltivar{}}
                                                          {\ltiT{j}}}}}
                     {\ltiE{}}
                     ...
                     \\\\
                     \overrightarrow{\ltiSdsubtype{\ltiSp{j}}
                                                  {\ltiS{j}}}
    }
    {
    \ltitSdjudgement{\ltiEnv{}}
    ...
    \ltitSdjudgement{\ltiEnv{}}
                    ...
                    {\ltiFp{}}
                     \\\\
    \ltiSdsubtype{\ltiS{}}{\ltiRec{\ova{\hastype{\ltivar{}}{\ltiT{}}}^n}}
    }
    {
    \ltitSdjudgement{\ltiEnv{}}
                  {\ltisel{\ltiF{}}{\ltivar{i}}}
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}-1}
                                                  {\ltiClosureCache{}}}
                      {\ltiEnvConcat{\ova{\ltitvar{}}}{\ltiEnvConcat{\ltiEnvp{}}{\hastype{\ltivar{}}{\ltiTp{}}}}}
                      {\ltiEpp{}}
                      {\ltiS{}}
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}}
                                                  {\ltiClosureCache{1}}}
                      {\ltiEnv{}}
                      {\ltiufunelab{\ova{\ltiufunelabentry{\ltiClosureIDp{}}}}
                                   {\ltivar{}}
                                   {\ltiE{}}}
                      {\ltiClosureWithStkID
                                           {\ltiEnv{}}
                      ...
                      {\ltimakeCombinedThreadedEnv{\ltiFuelp{}}
                                                  {\ltiClosureCache{4}}}
                      {\ltiufunelab{\ltiufunelabentry{\ltiClosureID{}}, \ova{\ltiufunelabentry{\ltiClosureIDp{}}}}
                                   {\ltivar{}}
                                   {\ltiE{}}}
                 }
  \end{mathpar}
