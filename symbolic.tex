...
We can better understand this issue by reviewing the idea of
...
%   (fn [x] (f f)))
% => 
% (let [f (ann (fn [f x] (f x))
%              [Bot -> Top])]
%   (fn [x] (f f)))
% => 
% (let [f (ann (fn [f x] (f x))
%              [Bot -> Top])]
%   (fn [x] ((fn [f x] (f x)) (fn [f x] (f x)))))
% => 
% (let [f (ann (fn [f x] (f x))
%              [Bot -> Top])]
%   (ann (fn [x] ((fn [f x] (f x)) (fn [f x] (f x))))
%        [Bot -> Top]))
...
with symbolic closure types and subtyping.
...
\begin{figure}
  \begin{mathpar}
    ...
    \\
    \ltitfjudgement{\ltiFuel{} - 1}
                   {\ltiEnv{},\hastype{\ltivar{}}{\ltiSyn{\ltiT{}}}}
                   {\ltiE{}}
                   {\ltiSynChk{\ltiS{}}}
                   {\ltiFuelp{}}
    }
