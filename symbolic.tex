...
\begin{figure}
  \begin{mathpar}
    ...
    % FIXME ordering of contexts?
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiunifyContextsLHS{\ltiinternallabel}{\ltistackmapping{\ltiEnv{}}{\ltiS{}}}{\ltiEnvp{}}}{\ltiT{}}
          }
...
\begin{figure}
  \begin{mathpar}
    ...
    \begin{array}{lcl}
      \ltiresolvealign{\ltiInternalOrExternalLang{}}
                      ...
                      {\ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}\ 
                                   ...
                                   \ova{\ltiunifyContexts{\ltiInternalOrExternalLang{}}
                                                         {\ltiContextualFn{\ltiEnv{j}}{\ltiT{j}}{\ltiS{j}}}
                                                                          {\ltiEnv{}}
                                                                          {\ltiFn{\ltiTp{j}}{\ltiSp{j}}}
                                                                          }\arcr
                                   \ova{\ltiunifyContexts{\ltiInternalOrExternalLang{}}
                                                         {\ltiContextualFn{\ltiEnv{k}}{\ltiT{k}}{\ltiS{k}}}
                                                                          {\ltiEnv{}}
                                                                          {undefined}
                                                                          }
                                   \end{array}
      ...
      \ltiresolvealign{\ltiInternalOrExternalLang{}}{\ltiEnv{}}
                      {\ltiPoly{\ova{\ltitvar{}}}{\ltiT{}}}
                      {\ltiPoly{\ova{\ltitvar{}}}{\ltiresolveLHS{\ltiInternalOrExternalLang{}}{\ltiEnv{}}{\ltiT{}}}}\\
      \ltiresolvealign{\ltiInternalOrExternalLang{}}{\ltiEnv{}}
                      {\ltiMu{\ltitvar{}}{\ltiT{}}}
    ...
    \boxed{\ltiunifyContexts{\ltiInternalOrExternalLang{}}{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiT{}}}}{\ltiEnv{}}{\ltiS{}}
    ...
    \begin{array}{llll}
      \ltiunifyContextsalign{\ltiInternalOrExternalLang{}}{\ltistackmapping{\ltiEmptyEnv{}}{\ova{\ltiT{}}}}{\ltiEnv{}}{\ova{\ltiT{}}} \\
      \ltiunifyContextsalign{\ltiInternalOrExternalLang{}}{\ltistackmapping{\ltiEnvConcat{\ltitvarp{}}{\ltiEnvp{}}}{\ova{\ltiT{}}}}
                            {\ltiEnvConcat{\ltitvar{}}{\ltiEnv{}}}
                            {\ltiunifyContextsLHS{\ltiInternalOrExternalLang{}}
                                                 {\ltistackmapping{\ltireplace{\ltitvar{}}{\ltitvarp{}}{\ltiEnvp{}}}
                                                                  {\ova{\ltireplace{\ltitvar{}}{\ltitvarp{}}{\ltiT{}}}}}
                                                 {\ltiEnv{}}}\\
      \ltiunifyContextsalign{\ltiInternalOrExternalLang{}}{\ltistackmapping{\ltiEnvConcat{\hastype{\ltivarp{}}{\ltiSp{}}}{\ltiEnvp{}}}{\ova{\ltiT{}}}}
                            {\ltiEnvConcat{\hastype{\ltivar{}}{\ltiS{}}}{\ltiEnv{}}}
                            {\ltiunifyContextsLHS{\ltiInternalOrExternalLang{}}{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiT{}}}}
                                                 {\ltiEnv{}}},
                                                 \\
                                                 &&&
                                                 \text{if } \ltiLsubtypeseen{\ltiInternalOrExternalLang{}}{}{\ltiS{}}{\ltiSp{}}
    \end{array}
  ...
  \begin{mathpar}
    ...
    \ltitSdjudgement{\ltiEnv{}}
         ...
         \ltiresolve{\ltiexternallanglabel}
                  ...
                  \\\\
                  \ova{\ova{{\ltiR{k}^j}}^p}^m = \{ \ova{\ltiR{}} | i \in 1 ... n,
                        \ltiunifyContexts{\ltiexternallanglabel{}}{\ltistackmapping{\ltiEnv{i}}{\ova{\ltiRp{}}_i}}{\ltiEnv{}}{\ova{\ltiR{}}} \}
                  \\\\
                  1 \leq j \leq m 
                  \\ m > 0 
                  \\ p = |\ova{\ltitvar{}}|
