...
problem, this limit will prematurely halt programs that would
...
For cases with more heterogenous argument and return types,
like the y-combinator,
the error message would just note which function caused
