...
\begin{figure}
  \begin{mathpar}
    ...
    \\\\
    \text{Helper function similar, except takes a prefix of the current context as first argument.
    }
    }
    }

    \begin{array}{llll}
      \ltiunifyContextsalign{\ltiInternalOrExternalLang{}}{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiT{}}}}{\ltiEnv{}}
