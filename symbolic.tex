...
Since inserting conditional types solves many woes, we now
explore when we decide to insert conditional types.
Here, the most attractive use of conditional types is to check the
same piece of code at different types.
Since a piece of code is only checked twice in the case of a function
intersection,
...
\begin{array}{lrll}
  ...
  \ltiT{}, \ltiS{}, \ltiR{} &::=& \ltitvar{} \alt
                         ...
                         \ltiPoly{\ova{\ltitvar{}}}{\ltiIFn{\ova{\ltiFn{\ova{\ltiT{}}}{\ltiT{}}}}}
                         \alt
