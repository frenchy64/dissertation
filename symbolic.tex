...
\begin{figure}
  \begin{mathpar}
    ...
    %             {}
    %{
    %  \ltitjudgement{\ltiEnv{}}{\ltiE{}}{\ltiT{}}{\ltiF{}}
    %  \\\\
    %  \text{\ltiE{} is of type \ltiT{} in context \ltiEnv{},}
    %  \\\\
    %  \text{with elaboration \ltiF{}}.
    %             }
    %             }
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{}}
                      ...
                      {\ltiEp{}}
                     \\\\
                     \text{Given combined environment \ltiCombinedThreadedEnv{}
                     ...
                     \\\\
                     \text{
                     with updated combined environment \ltiCombinedThreadedEnvp{},
  ...
  \caption{Algorithmic Type system for Symbolic Closure Language (mostly-standard rules)
  }
  \label{symbolic:figure:SC-language-algorithmic-type-system-standard-rules}
\end{figure}
