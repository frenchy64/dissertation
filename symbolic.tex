...
\begin{figure}
  \begin{mathpar}
    ...
    \ltiunfold{\ltiT{}^f}
               {\ltiPoly{\ova{\ltitvar{}}}
                        {\ltiIFn{\ova{\ltiContextualFn{\ltiEnvp{}}{\ltiT{}}{\ltiS{}}}}}}
                  \\\\
                  % FIXME this is just findTAS inlined
    ...
    \\\\
                  ...
                  %\ltiSfindTA{\ltiCombinedThreadedEnv{3}}
                  %           {\ltiEnv{}}
                  %           {\ova{\ltitvar{}}}
                  %           {\ova{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiRp{}}}}}
                  %           {\ova{\ltiR{}}}
    ...
    \\
    \overrightarrowcaption{
      (\ova{\ltiSp{}}_i, \ltiCombinedThreadedEnvp{i})
        = \left\{
                     \begin{array}{llll}
                       (\ova{\ltiSp{}}_{i-1}\ltiS{i}, \ltiCombinedThreadedEnvp{i})
                       , &\text{if } \ltiSsubtype{\ltiCombinedThreadedEnvp{i-1}}
                                                 ...
                                                 {\ltiCombinedThreadedEnvp{i}}
                                                  \arcr
                       (\ova{\ltiSp{}}_{i-1}, \ltiCombinedThreadedEnvp{i-1}),  &\text{otherwise}
                     \end{array}
                   \right.
                   }^{1 \leq i \leq n}
                   \\
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                      ...
                      {\ltiappinst{\ltiF{}}
                                  {\ova{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiRp{}}}}}
                                  {\ltiE{}}}
                      {\ltiMeetMany{\ltireplace{\ova{\ltiR{}}}{\ova{\ltitvar{}}}{\ova{\ltiSp{}}_n}}}
