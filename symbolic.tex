...
Using these rules, we now illustrate how to check
                      ``{\ltilet{\text{g}}{\ltiRec{\text{d}={{\ltiufun{\ltivar{}}{\ltiF{}}}}}}
                              {\ltiapp{\ltisel{\text{g}}{\text{d}}}{\ltiE{}}}}'',
an obfuscation of ``{\ltiappParens{\ltiufun{\ltivar{}}{\ltiF{}}}{\ltiE{}}}''
where the function is the $\text{d}$ entry in a let-bound record and then immediately extracted.
...
is checked using the left subderivation ending in \ltiSimpUAbs.
To delay its checking, {\colorbox{pink}{\ltiufun{\ltivar{}}{\ltiF{}}}}
...
The right subderivation binds this record type as $\text{g}$ in the type environment,
and checks the body ``{\ltiapp{\ltisel{\text{g}}{\text{d}}}{\ltiE{}}}''.
...
(because that is the type of ${\text{g}}$'s ${\text{d}}$ field).
The argument \ltiE{} is checked as type {\colorbox{pink}{\ltiS{}}}.
Now, {\colorbox{pink}{\ltiEnv{}}}, {\colorbox{pink}{\ltivar{}}},
and {\colorbox{pink}{\ltiF{}}}
are extracted from the symbolic closure
and, along with {\colorbox{pink}{\ltiS{}}}, used to check (essentially)
our unobfuscated term ``{\ltiappParens{\ltiufun{\ltivar{}}{\ltiF{}}}{\ltiE{}}}''
with the derivation
    ``\ltitSstkjudgementNoElabCombined{\ltiClosureCache{}}
                      {\ltiEnvConcat{\colorbox{pink}{\ltiEnv{}}
                                     }
...
would have failed to infer this term exactly
