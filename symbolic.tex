...
Hosoya and Pierce outline the two main complications that must be
addressed to avoid hard-to-synthesize arguments.
First, we must provide a strategy to identifying which arguments 
should be avoided.
...
They mostly show why the naive approach does not suffice.
We use these challenges as a presentational framework 
