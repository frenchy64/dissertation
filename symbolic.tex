...
\begin{array}{lrll}
  ...
  \\
  \ltifuninterface{\ltiT{}}{\ova{\ltivar{}}}{\ltiE{}} &\Leftrightarrow& \ltiann{\ltiufun{\ova{\ltivar{}}}{\ltiE{}}}{\ltiT{}}
  \\
...
\begin{figure}
  \begin{mathpar}
    ...
    \\\\
    \lticheckFn{\ltiEnclosingFnStack{}}
               {\ltiEnv{}}
               {\ltivar{}}
               {\ltiE{}}
               {\ltiTp{}}
    ...
    {}
    {
    \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiT{}}{\ltiT{}}
    }

    \infer [S-Trans]
    {
    \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiS{}}{\ltiTp{}}
    \\
    \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiTp{}}{\ltiT{}}
    }
    {
    ...
    %{ \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiUnion{\ova{\ltiT{}}}}{\ltiS{}} }

    %\infer [S-UnionR]
    %{ \exists i. \ltiisubtypeseen {\ltiSubtypeSeen{}}{\ltiT{}} {\ltiS{i}}}
    %{ \ltiisubtypeseen {\ltiSubtypeSeen{}}{\ltiT{}} {\ltiUnion{\ova{\ltiS{}}}}}

    %\infer [S-IntersectL]
    %{ \exists i. \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiT{i}} {\ltiS{}}}
    %{ \ltiisubtypeseen {\ltiSubtypeSeen{}}{\ltiIntersection{\ova{\ltiT{}}}}{\ltiS{}} }

    %\infer [S-IntersectR]
    %{ \overrightarrow {\ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiT{}}{\ltiS{}}}}
    %{ \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiT{}}{\ltiIntersection{\ova{\ltiS{}}}} }
...
%    {
%    \ltiisubtypeseen{\ltiSubtypeSeen{}}
%                    {\ltiPoly{\overline{\ltitvar{}}}{\ltiTp{}}}
%                    {\ltiT{}}
%    }
%    {
%    \ltiisubtypeseen{\ltiSubtypeSeen{}}
%                    {\ltiPoly{\overline{\ltitvar{}}}{\ltiTp{}}}
%                    {\ltiAppAll{\ltiT{}}{\ova{\ltiS{}}}}
%    }
%
%    \infer [S-AppL]
%    {}
%    {
%    \ltiisubtypeseen{\ltiSubtypeSeen{}}
%                    {\ltiAppAll{\ltiPoly{\overline{\ltitvar{}}}{\ltiT{}}}{\ova{\ltiS{}}}}
%                    {\ltireplace{\ova{\ltiS{}}}{\ova{\ltitvar{}}}{\ltiT{}}}
%    }
    ...
    { \ltiisubtypeseen{\ltiSubtypeSeen{}}
                      {\ltiIFn{\ova{\ltiFn{\ltiSp{}}{\ltiT{}}}^m}}
                      {\ltiIFn{\ova{\ltiFn{\ltiS{}}{\ltiTp{}}}^n}}
                   }
  \end{mathpar}
...
%                                {\ltiAppAllOne{\ova{\ltiexpandEnclosingFnLHS{\ltiEnclosingFnStack{}}{\ltiT{}}}}}\\
    ...
    \infer[]
    {}
    {\boxed{\lticheckFn{\ltiEnclosingFnStack{}}
                {\ltiEnv{}}
                {\ltivar{}}
                {\ltiE{}}
                {\ltiT{}}
                \text{ Check that function \ltiufun{\ltivar{}}{\ltiE{}}
                is resolved type \ltiT{} in contexts \ltiEnclosingFnStack{} and \ltiEnv{}.
                }
                }
                }
    \\
    ...
    \ltitstkjudgement{\ltiStackPush{\ltiEnclosingFnStack{}}{\ltiIFn{\ltiFn{\ltiT{i}}{\ltiS{i}}}}}
                     {\ltiEnvConcat{\hastype{\ltivar{}}{\ltiT{i}}}{\ltiEnv{}}}
                     {\ltiE{}}
                     {\ltiS{i}}
                 }
    {\lticheckFn{\ltiEnclosingFnStack{}}
...
%                {\ltivar{}}
%                {\ltiE{}}
%                {\ltiAppAll{\ltiPoly{\ova{\ltitvar{}}}{\ltiT{}}}
%                           {\ova{\ltiS{}}}}
%                }

    \infer[]
    { \lticheckFn{\ltiEnclosingFnStack{}}
                 % parens to disambiguate from commas
                 {(\ltiEnvConcat{\ova{\ltitvar{}}}{\ltiEnv{}})}
                 {\ltivar{}}
                 {\ltiE{}}
                 {\ltiT{}}
                 }
    ...
    \infer[]
    {}
    {\boxed{\lticheckApp{\ltiT{}}
                        {\ltiS{}}
                        {\ltiTp{}}
                 \text{ Return result type \ltiTp{}
                 of applying function of type \ltiT{}
                 to argument of type \ltiS{}.
                 }
                }}
                \\
    \infer[]
    ...
    {\lticheckApp{\ltiIFn{\ova{\ltiFn{\ltiT{}}{\ltiS{}}}}}
                 {\ltiTp{}}
                 {\ltiIntersection{\ova{\ltiSp{}}}}
                }

                % Union
%    \infer[]
%    { \overrightarrow{\lticheckApp{\ltiT{}}
%                                  {\ltiS{}}
%                                  {\ltiSp{}}}
%                 }
%    {\lticheckApp{\ltiUnion{\ova{\ltiT{}}}}
%                 {\ltiS{}}
%                 {\ltiUnion{\ova{\ltiSp{}}}}
%                }
                ...
                % Intersection
%    \infer[]
%    { \exists i. \lticheckApp{\ltiT{i}}{\ltiS{}}{\ltiTp{i}}
%      \\
%      \ltiSp{i} = \left\{
%                     \begin{array}{ll}
%                       \ltiTp{i}, &\text{ if } \lticheckApp{\ltiT{i}}{\ltiS{}}{\ltiTp{i}} \arcr
%                       \ltiTop,  &\text{ otherwise}
%                     \end{array}
%                   \right.
%                 }
%    {\lticheckApp{\ltiIntersection{\ova{\ltiT{}}}}
%                 {\ltiS{}}
%                 {\ltiIntersection{\ova{\ltiSp{}}}}
%                }
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{2}}
                      ...
                      {\ltiEp{}}
                  \\\\
    \lticheckAppSC{\ltiCombinedThreadedEnv{3}}{\ltiT{}}{\ltiS{}}{\ltiTp{}}{\ltiCombinedThreadedEnv{4}}
    \\\\
    \ltimonoRng{\ltiTp{}}{\ltiTpp{}}
    \\\\
    \ltiwrapTypeCase{\ltiEnclosingFnStack{}}{\ltiTp{}}{\ltiSp{}}
    }
    {
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                      {\ltiEnclosingFnStack{}}
                      ...
                      {\ltiapp{\ltiann{\ltiFp{}}{\ltiSp{}}}{\ltiEp{}}}
    }
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                      ...
                      {\ltiEp{}}
                     \\\\
                     \ltiSsubtype{\ltiCombinedThreadedEnv{2}}
                                 {\ltiS{}}
                                 {\ltiT{}}
                                 {\ltiCombinedThreadedEnv{3}}
    }
  ...
  \caption{Type system for Symbolic Closure Language:
   \ltitSstkjudgement{\ltiCombinedThreadedEnv{}}
                     {\ltiEnclosingFnStack{}}
                     {\ltiEnv{}}
                     {\ltiE{}}
  ...
  \label{symbolic:figure:SC-language-type-system}
\end{figure}
...
%    }
    ...
    \ltitSstkjudgement{\ltimakeCombinedThreadedEnv{\ltiFuel{}-1}
                      ...
                      {\ltiEl{}}
                      \\\\
    \ltiClosureCacheVal{\ltiIFn{\ova{\ltiFn{\ltiTp{}}{\ltiSp{}}}}}{\ltiF{}} = \ltilookup{\ltiClosureID{}}{\ltiClosureCachep{}}
    \\\\
    \ltiClosureCachepp{} = \ltimapsto{\ltiClosureID{}}
  ...
  \caption{Subtyping for Symbolic Closure Language:
...
\begin{figure}
  ...
  \begin{mathpar}
    \infer[]
    {}
    {\boxed{\lticheckAppSC{\ltiCombinedThreadedEnv{}}{\ltiT{}}{\ltiS{}}{\ltiTp{}}{\ltiCombinedThreadedEnvp{}}
    \text{
    Returns a monomorphic instantiation of operator \ltiT{}
    that accepts operand \ltiS{}.
    }
                }}
                \\
    \infer[]
    { 
      1 \leq i \leq n
      \\\\
     \exists i, \ltiCombinedThreadedEnvpp{}. \ltiSsubtype{\ltiCombinedThreadedEnv{0}}{\ltiTp{}}{\ltiT{i}}{\ltiCombinedThreadedEnvpp{}}
    \\\\
      (\ltiSp{i}, \ltiCombinedThreadedEnv{i})
        = \left\{
                     \begin{array}{lll}
                       (\ltiIFn{\ltiFn{\ltiT{i}}{\ltiS{i}}}, &\ltiCombinedThreadedEnvp{i})
                       , &\text{if } \ltiSsubtype{\ltiCombinedThreadedEnv{i-1}}
                                                  {\ltiTp{}}
                                                  {\ltiT{i}}
                                                  {\ltiCombinedThreadedEnvp{i}}
                                                  \arcr
                       (\ltiTop, &\ltiCombinedThreadedEnv{i-1}),  &\text{otherwise}
                     \end{array}
                   \right.
                 }
    {\lticheckAppSC{\ltiCombinedThreadedEnv{0}}
                   {\ltiIFn{\ova{\ltiFn{\ltiT{}}{\ltiS{}}}^n}}
                   {\ltiTp{}}
                   {\ltiIntersection{\ova{\ltiSp{}}}}
                   {\ltiCombinedThreadedEnv{n}}
    ...
    \infer[]
    {}
    {\lticheckAppSC{\ltiCombinedThreadedEnv{}}
                   {\ltiBot}
                   {\ltiTp{}}
                   {\ltiBot}
                   {\ltiCombinedThreadedEnv{}}}
    ...
    %{ 1 \leq i \leq n
    %  \\\\
    %  \lticheckAppSC{\ltiCombinedThreadedEnv{i-1}}
    %                {\ltiT{i}}
    %                {\ltiS{}}
    %                {\ltiSp{i}}
    %                {\ltiCombinedThreadedEnv{i}}
    ...
    %{ 1 \leq i \leq n
    %  \\
    %  \exists i. \lticheckAppSC{\ltiCombinedThreadedEnv{0}}
    %                           {\ltiT{i}}
    %                           {\ltiS{}}
    %                           {\ltiTp{i}}
    ...
    %             = \left\{
    %                 \begin{array}{lll}
    %                   (\ltiTp{i}, &\ltiCombinedThreadedEnvp{i}),
    %                              &\text{if } \lticheckAppSC{\ltiCombinedThreadedEnv{i-1}}
    %                                                         {\ltiT{i}}
    %                                                         {\ltiS{}}
    %                                                         {\ltiTp{i}}
    %                                                         {\ltiCombinedThreadedEnvp{i}} \arcr
    %                   (\ltiTop, &\ltiCombinedThreadedEnv{i-1}),
    %                              &\text{otherwise}
    %                 \end{array}
    %               \right.
    %             }
    %{\lticheckAppSC{\ltiCombinedThreadedEnv{0}}
    %               {\ltiIntersection{\ova{\ltiT{}}^n}}
    %               {\ltiS{}}
    %               {\ltiIntersection{\ova{\ltiSp{}}^n}}
    %               {\ltiCombinedThreadedEnv{n}}
    %            }

%    \infer[]
%    {\lticheckAppSC{\ltiCombinedThreadedEnv{}}
%                   {\ltireplace{\ova{\ltiTp{}}}{\ova{\ltitvar{}}}{\ltiT{}}}
%                   {\ltiS{}}
%                   {\ltiSp{}}
%                   {\ltiCombinedThreadedEnvp{}}
%                }
...
%                }
    ...
    {TODO }
    {\lticheckAppSC{\ltiCombinedThreadedEnv{}}
                   {\ltiClosureWithStkID{\ltiEnclosingFnStack{}}{\ltiEnv{}}{\ltiClosureID{}}{\ltiufun{\ltivar{}}{\ltiE{}}}}
                   {\ltiS{}}
                   {\ltiSp{}}
                   {\ltiCombinedThreadedEnvp{}}
                }

    % no checkAppSC case needed for Mu because we only insert them after elaboration,
    % and disallow their use in user annotations in the SC language

  \end{mathpar}

  \[
    \boxed{\ltimonoRng{\ltiT{}}{\ltiS{}}
    \text{ Returns the range \ltiS{} of the monomorphic type \ltiT{}.}
    }
  \]

  \[
  \begin{array}{llll}
    %\ltimonoRngalign{\ltiIntersection{\ova{\ltiT{}}^n}}
    %                {\ltiIntersection{\ova{\ltimonoRngLHS{\ltiT{}}}}}
    %                & \text{where } n>0
    %                \\
    %\ltimonoRngalign{\ltiUnion{\ova{\ltiT{}}}}
    %                {\ltiUnion{\ova{\ltimonoRngLHS{\ltiT{}}}}}
    %                \\
    \ltimonoRngalign{\ltiBot}
                    {\ltiBot}
                    \\
    \ltimonoRngalign{\ltiIFn{\ova{\ltiFn{\ltiT{}}{\ltiS{}}}^n}}
                    {\ltiIntersection{\ova{\ltiS{}}}}
                    & \text{where } n>0
                    \\
    \ltimonoRngalign{\ltiMu{\ltitvar{}}{\ltiT{}}}
                    {\ltimonoRngLHS{\ltireplace{\ltiMu{\ltitvar{}}{\ltiT{}}}{\ltitvar{}}{\ltiT{}}}}
                    \\
                    % TODO resolve under operator first
    %\ltimonoRngalign{\ltiAppAll{\ltiPoly{\overline{\ltitvar{}}}{\ltiT{}}}{\ova{\ltiS{}}}}
    %                {\ltimonoRngLHS{\ltireplace{\ova{\ltiS{}}}{\ova{\ltitvar{}}}{\ltiT{}}}}
  \end{array}
  \]
...
\begin{figure}
  ...
  \begin{array}{llll}
    ...
    %\ltielimClosTalign{\ova{\ltiClosureID{}}}{\ltiClosureCache{}}
    %                  {\ltiAppAllOne{\ova{\ltiT{}}}}
    %                  {\ltiAppAllOne{\ova{\ltielimClosTLHS{\ova{\ltiClosureID{}}}{\ltiClosureCache{}}{\ltiT{}}}}}
    %                                      \\
    \ltielimClosTalign{\ova{\ltiClosureID{}}}{\ltiClosureCache{}}
                      {\ltiTypeCase{\ltiT{}}
