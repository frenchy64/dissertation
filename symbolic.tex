...
%                      \\
  ...
  \ltiClosureCache{} &::=& \ova{\ltiClosureCacheEntry
                                {\ltiClosureID{}}
                                {\ltiClosureWithStkID{\ltiEnv{}}{\ltiE{}}{\ltiT{}}}}
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{}}
                     ...
                     \\\\
                     \text{ with elaboration \ltiEp{} (omitted when clearly derivable from subderivations).
                     }
                     }
                     }
...
\ \ \ 
    ...
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{1}}
                      ...
                      {\ltimakeCombinedThreadedEnv{\ltiFuel{4}}
                          {\ltiupdateClosureCacheLHS{\ltiClosureCache{4}}
                                {\ltiEnv{}}%TODO delete this parameter
                                {\ltiClosureID{}}
                                {\varnothing}
                                {\ltiT{}}
                                {\ltiS{}}
...
%
    ...
    {\ltimapsto{\ltiClosureCache{}}
               {\ltiClosureID{}}
               {\ltiClosureWithStkID{\ltiEnv{}}{\ltiufun{\ltivar{}}{\ltiE{}}}{\ltiTop}}}
    }
    {
    \ltitSstkjudgement{\ltiCombinedThreadedEnv{}}
                      {\ltiEnv{}}
...
\begin{figure}
  \begin{mathpar}
    ...
    Assumes \ova{\ltitvar{}} do not occur free in \ltiClosureID{}'s body.}
    }}
    \\
