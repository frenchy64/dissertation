...
\begin{figure}
  \begin{mathpar}
    ...
    \\\\
    \ltiEnvp{} = \ltiEnvConcat{\ltiEnv{}}
                              {\ova{\ltitvar{}}}
    \\\\
    \overrightarrow{
    \ltitjudgement{\ltiEnvConcat{\ltiEnvp{}}{\hastype{\ltivar{}}{\ltiresolveLHS{\ltiEnvp{}}{\ltiT{i}}}}}
                  {\ltiE{}}
                  {\ltiS{i}}
                  }
    \\\\
    \overrightarrow{
    \ltitjudgement{\ltiEnvConcat{\ltiEnv{j}}
    ...
    {
    \ltitjudgement{\ltiEnv{}}
                  {\ltiappinst{\ltiF{}}{\ova{\ltistackmapping{\ltiEnvp{j}}{\ova{\ltiR{j}}}}}{\ltiE{}}}
...
\begin{figure}
  \begin{mathpar}
    ...
    \boxed{\ltiunifyContexts{\ltistackmapping{\ltiEnvp{}}{\ltiT{}}}{\ltiEnv{}}{\ltiS{}}
    \text{ Use \ltiT{}'s context \ltiEnvp{} to prepare \ltiT{} for use in current context \ltiEnv{}.
    }
    }
