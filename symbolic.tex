...
for the unannotated term \ltiufun{\ltivar{}}{\ltiE{}}.
The return type is a symbolic closure type
                       \ltiClosureWithStkID{\ltiEnv{}}
                                           {\ltiClosureID{}}
                                           {\ltiufun{\ltivar{}}{\ltiE{}}}
that holds enough information to check its body at some later time
and link it back to its originating term.
The elaboration cache entry for \ltiClosureID{} is initialized 
with an unannotated term, signifying that the body has yet to be type checked
...
applied to terms of type \ltiT{}, which we
we verify with a symbolic reduction.
After consuming fuel, the final premise checks \ltiF{}'s
function body \ltiEp{} in its definition context \ltiEnvp{},
extended with \hastype{\ltivar{}}{\ltiT{}} (to account for
\ltiE{} being passed as an argument), giving type \ltiS{}
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltiupdateClosureCacheSingle{\ltiClosureCache{2}}
                          ...
                          {\ltiClosureCache{3}}
                      \\
    \ltiSsubtype{\ltimakeCombinedThreadedEnv{\ltiFuel{2}}{\ltiClosureCache{3}}}{\ltiEnv{}}{\ltiSp{}}{\ltiS{}}
                {\ltiCombinedThreadedEnv{4}}
    }
...
\begin{figure}
  \begin{mathpar}
    ...
    \\\\
    \text{Associate function tagged with closure identifier \ltiClosureID{} with SCL elaboration \ltiE{}.
    }
    }
    }
