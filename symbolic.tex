...
We are then unable to give a suitable annotation to the return function
of \clj{f}.
...
We must take special consideration of variable shadowing when using \clj{TypeOf}---for
