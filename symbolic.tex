...
\begin{figure}
  \begin{mathpar}
    ...
    \\\\
    \ltiunfoldLHS{\ltiT{}} =
      \ltiPoly{\ova{\ltitvar{}}}{\ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}^n}{\ova{\ltiContextualFn{\ltiEnv{j}}{\ltiT{j}}{\ltiS{j}}}^m}}
    \\\\
    \overrightarrow{
    \ltiEnv{i} = \ltiEnvConcat{\ltiEnvConcat{\ltiEnv{}}{\ova{\ltitvar{}}}}{\hastype{\ltivar{}}{\ltiresolveLHS{\ltiEnvConcat{\ltiEnv{}}{\ova{\ltitvar{}}}}{\ltiT{i}}}}
    }
    \\\\
    \overrightarrow{
    \ltitjudgement{\ltiEnv{i}}
                  {\ltiE{}}
                  {\ltiSp{i}}
                  }
    \\
    \overrightarrow{\ltiisubtype{\ltiSp{i}}{\ltiresolveLHS{\ltiEnv{i}}{\ltiS{i}}}}
    \\\\
    \overrightarrow{
    \ltitjudgement{\ltiEnvConcat{\ltiEnv{j}}{\hastype{\ltivar{}}{\ltiT{j}}}}
                  {\ltiE{}}
                  {\ltiSp{j}}
                  }
    \\
    \overrightarrow{\ltiisubtype{\ltiSp{j}}{\ltiS{j}}}
    }
    {
    \ltitjudgement{\ltiEnv{}}
                  {\ltifuninterface{\ltiT{}}
                                   {\ltivar{}}{\ltiE{}}}
                  {\ltiPoly{\ova{\ltitvar{}}}{\ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}}{\ova{\ltiContextualFn{\ltiEnv{j}}{\ltiT{j}}{\ltiS{j}}}}}}
                 }
    ...
    \ltitjudgement{\ltiEnv{}}
                  ...
                  {\ltiTp{}}
                  \\\\
                  \ltiunfold{\ltiSpp{}}{\ltiPoly{\ova{\ltitvar{}}}{\ltiTpp{}}}
                  \\\\
                  \exists! k \in 1...m.\ 
                  \ltiunifyContexts{\ltistackmapping{\ltiEnvp{k}}{\ova{\ltiR{}}_k}}{\ltiEnv{}}
                                   {\ova{\ltiR{}}}
                  \\\\
                  \ltireplace{\ova{\ltiR{}}}{\ltitvar{}}{\ltiTpp{}} =
                  \ltiIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}^n}
                  \\\\
    ...
    {
    \ltitjudgement{\ltiEnv{}}
                  {\ltiappinst{\ltiF{}}{\ova{\ltistackmapping{\ltiEnvp{j}}{\ova{\ltiR{}}_j}}^m}{\ltiE{}}}
    ...
    {
    \ltitjudgement{\ltiEnv{}}
                  {\ltiappinst{\ltiF{}}{\ova{\ltistackmapping{\ltiEnvp{j}}{\ova{\ltiR{}}_j}}}{\ltiE{}}}
                  {\ltiBot{}}
    }
    ...
    \infer [S-Poly]
    {
    \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiS{}}{\ltiT{}}
    }
    { \ltiisubtypeseen{\ltiSubtypeSeen{}}
    ...
    { \forall i \in 1...n.\ 
        \exists j \in 1...m.\ 
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiS{i}}{\ltiT{j}}
          \\\\
      \forall i \in 1...p.\ 
        \exists j \in 1...q.\ 
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiSp{i}}{\ltiTp{j}}
    }
    { \ltiisubtypeseen{\ltiSubtypeSeen{}}
                      {\ltiSplitIFn{\ova{\ltiS{}}^m}{\ova{\ltiSp{}}^q}}
                      {\ltiSplitIFn{\ova{\ltiT{}}^n}{\ova{\ltiTp{}}^p}}
                   }

    \infer [S-Fn]
    {
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiS{}}{\ltiSp{}}
          \\\\
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiT{}}{\ltiTp{}}
          }
    {\ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiFn{\ltiSp{}}{\ltiT{}}}{\ltiFn{\ltiS{}}{\ltiTp{}}}}

    \infer [S-CFn]
    {
    % FIXME ordering of contexts?
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiS{}}{\ltiunifyContextsLHS{\ltistackmapping{\ltiEnv{}}{\ltiSp{}}}{\ltiEnvp{}}}
          \\\\
    % FIXME ordering of contexts?
          \ltiisubtypeseen{\ltiSubtypeSeen{}}{\ltiunifyContextsLHS{\ltistackmapping{\ltiEnv{}}{\ltiT{}}}{\ltiEnvp{}}}{\ltiTp{}}
          }
    {\ltiisubtypeseen{\ltiSubtypeSeen{}}{(\ltiContextualFn{\ltiEnv{}}{\ltiSp{}}{\ltiT{}})}
                                        {(\ltiContextualFn{\ltiEnvp{}}{\ltiS{}}{\ltiTp{}})}
    }
...
\begin{figure}
  \begin{mathpar}
    ...
    \boxed{\ltiresolve{\ltiEnv{}}{\ltiT{}}{\ltiS{}}
    \text{ Resolve contextual types in \ltiT{} using \ltiEnv{}.
    }
    }

    \begin{array}{lcl}
      \ltiresolvealign{\ltiEnv{}}
                      {\ltiSplitIFn{\ova{\ltiFn{\ltiT{i}}{\ltiS{i}}}}
                                   {\ova{\ltiContextualFn{\ltiEnv{j}}{\ltiT{j}}{\ltiS{j}}}\ 
                                    \ova{\ltiContextualFn{\ltiEnv{k}}{\ltiT{k}}{\ltiS{k}}}
                                   }}
                      {\ltiSplitIFn{\ova{\ltiFn{\ltiresolveLHS{\ltiEnv{}}{\ltiT{i}}}{\ltiresolveLHS{\ltiEnv{}}{\ltiS{i}}}}\ 
                                    \ova{\ltiFn{\ltiTp{j}}{\ltiSp{j}}}}
                                   {\ova{\ltiContextualFn{\ltiEnv{k}}{\ltiT{k}}{\ltiS{k}}}}}
                                   \\
                                   &&\text{ where }\\
                                   &&\text{ }
                                   \begin{array}{lll}
                                   \ova{\ltiunifyContexts{\ltiContextualFn{\ltiEnv{j}}{\ltiT{j}}{\ltiS{j}}}
                                                                          {\ltiEnv{}}
                                                                          {\ltiFn{\ltiTp{j}}{\ltiSp{j}}}
                                                                          }\arcr
                                   \ova{\ltiunifyContexts{\ltiContextualFn{\ltiEnv{k}}{\ltiT{k}}{\ltiS{k}}}
                                                                          {\ltiEnv{}}
                                                                          {undefined}
                                                                          }
                                   \end{array}
                                   \\
                                   %don't want to resolve under Poly since it changes the environment
      %\ltiresolvealign{\ltiEnv{}}
      %                {\ltiPoly{\ova{\ltitvar{}}}{\ltiT{}}}
      %                {\ltiPoly{\ova{\ltitvar{}}}{\ltiresolveLHS{\ltiEnv{}}{\ltiT{}}}}\\
      \ltiresolvealign{\ltiEnv{}}
                      {\ltiMu{\ltitvar{}}{\ltiT{}}}
                      {\ltiMu{\ltitvar{}}{\ltiresolveLHS{\ltiEnv{}}{\ltiT{}}}}\\
      \ltiresolvealign{\ltiEnv{}}
                      {\ltiRec{\ova{\hastype{\ltivar{}}{\ltiT{}}}}}
                      {\ltiRec{\ova{\hastype{\ltivar{}}{\ltiresolveLHS{\ltiEnv{}}{\ltiT{}}}}}}
                                                                \\
      \ltiresolvealign{\ltiEnv{}}{\ltiT{}}{\ltiT{}} \text{, otherwise}\\
    \end{array}

    \boxed{\ltiunifyContexts{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiT{}}}}{\ltiEnv{}}{\ltiS{}}
    \text{ Use \ova{\ltiT{}}'s context \ltiEnvp{} to prepare \ltiT{} for use in current context \ltiEnv{}.
    }
    }

    \begin{array}{llll}
      \ltiunifyContextsalign{\ltistackmapping{\ltiEmptyEnv{}}{\ova{\ltiT{}}}}{\ltiEnv{}}{\ova{\ltiT{}}} \\
      \ltiunifyContextsalign{\ltistackmapping{\ltiEnvConcat{\ltitvarp{}}{\ltiEnvp{}}}{\ova{\ltiT{}}}}
                            {\ltiEnvConcat{\ltitvar{}}{\ltiEnv{}}}
                            {\ltiunifyContextsLHS{\ltistackmapping{\ltireplace{\ltitvar{}}{\ltitvarp{}}{\ltiEnvp{}}}
                                                                  {\ova{\ltireplace{\ltitvar{}}{\ltitvarp{}}{\ltiT{}}}}}
                                                 {\ltiEnv{}}}\\
      \ltiunifyContextsalign{\ltistackmapping{\ltiEnvConcat{\hastype{\ltivarp{}}{\ltiSp{}}}{\ltiEnvp{}}}{\ova{\ltiT{}}}}
                            {\ltiEnvConcat{\hastype{\ltivar{}}{\ltiS{}}}{\ltiEnv{}}}
                            {\ltiunifyContextsLHS{\ltistackmapping{\ltiEnvp{}}{\ova{\ltiT{}}}}
                                                 {\ltiEnv{}}}
                                                 \\
                                                 &&&
                                                 \text{ if } \ltiisubtype{\ltiSp{}}{\ltiS{}}
    \end{array}
  \end{mathpar}
...
\begin{figure}
  \begin{mathpar}
    ...
    \ltitSdjudgement{\ltiEnv{}}
                    {\ltiappinst{\ltiFp{}}
                                {\ova{\ltistackmapping{\ltiEnvp{j}}{\ova{\ltiR{j}}}}}
                                {\ltiEp{}}}
                    {\ltiSp{}}
                    {\ltiappinst{\ltiFp{}}
                                {\ova{\ltistackmapping{\ltiEnvp{j}}{\ova{\ltiR{j}}}}}
    ...
    {
    \ltitSdjudgement{\ltiEnv{}}
                    {\ltifuntparaminterface{\ova{\ltistackmapping{\ltiEnvp{j}}{\ova{\ltitvar{j}}}}}
                                           {\ova{\ltistackmapping{\ltiEnvp{j}}{\ltiSp{j}}}}
                                           {\ltivar{}}{\ltiE{}}}
    ...
    \ltitSdjudgement{\ltiEnv{}}
                    ...
                    {\ltifuntparaminterface{\ltistackmapping{\ltiEnv{}}{\ova{\ltitvar{}}}}
                                           {\ltistackmapping{\ltiEnv{}}{\ltiTp{}}}
                                           {\ltivar{}}
                                           {\ltiEp{}}}
                 }
