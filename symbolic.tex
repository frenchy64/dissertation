...
\begin{figure}
  \begin{mathpar}
    ...
    \\
    \ova{\ltiSp{}}_0 = \varnothing
    \\\\
    \overrightarrowcaption{
      (\ova{\ltiSp{}}_i, \ltiCombinedThreadedEnvpp{i})
        = \left\{
                     \begin{array}{llll}
                       (\ova{\ltiSp{}}_{i-1}{\ltireplace{\ova{\ltiR{}}}{\ova{\ltitvar{}}}{\ltiS{i}}}, \ltiCombinedThreadedEnvpp{i})
                       , &\text{if } \ltiunifyContexts{\ltiInternalOrExternalLang{}}
                                                      {\ltistackmapping{\ltiEnv{i}}{\ltiFn{\ltiT{i}}{\ltiS{i}}}}
                                                      {\ltiEnvp{}}
                                                      {\ltiFn{\ltiTp{i}}{\ltiSp{i}}}\arcr
                         &\text{and }
                       \ltiSsubtype{\ltiCombinedThreadedEnvpp{i-1}}
                                                 {\ltiEnvp{}}
                                                 {\ltiT{}^a}
                                                 {\ltireplace{\ova{\ltiR{}}}{\ova{\ltitvar{}}}{\ltiT{i}}}
                                                 {\ltiCombinedThreadedEnvpp{i}}
                                                  \arcr
                       (\ova{\ltiSp{}}_{i-1}, \ltiCombinedThreadedEnvpp{i-1}),  &\text{otherwise}
                     \end{array}
                   \right.
                   }^{1 \leq i \leq n}
                   \\
