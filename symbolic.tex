...
\begin{array}{lrll}
  ...
  && \text{where } n \not= 1
  \\
  \ltilet{\ltivar{}}{\ltiE{}}{\ltiF{}} &\Leftrightarrow& \ltiappParens{\ltiufun{\ltivar{}}{\ltiF{}}}{\ltiE{}}
...
\begin{figure}
  \begin{mathpar}
    ...
    {\ltiSsubtype{\ltiCombinedThreadedEnv{}}
                 ...
                 \\\\
                 \text{
                 With symbolic closure cache \ltiCombinedThreadedEnv{},
                 \ltiS{} is a subtype of \ltiT{}
                 with updated symbolic closure cache
                 \ltiCombinedThreadedEnvp{}.
                 }
    }
    }
    ...
    \infer [SF-Fn]
    { \ltiSsubtype{\ltiClosureCache{1}}{\ltiEnv{}}{\ltiS{}}{\ltiSp{}}{\ltiClosureCache{2}}
      \\\\
      \ltiSsubtype{\ltiClosureCache{2}}{\ltiEnv{}}{\ltiT{}}{\ltiTp{}}{\ltiClosureCache{3}}
    }
    { \ltiSsubtype{\ltiClosureCache{1}}{\ltiEnv{}}
                  {\ltiFn{\ltiSp{}}{\ltiT{}}}
                  {\ltiFn{\ltiS{}}{\ltiTp{}}}
                  {\ltiClosureCache{3}}
       }
    ...
    \infer [SF-Closure]
    {
    \ltilookup{\ltiClosureCache{1}}{\ltiClosureID{}}
    =
    \ltiClosureCacheVal{\ltiFuel{}}{\ltiClosureElab{}}
    \\
    0 < \ltiFuel{}
    \\
    \ltitSstkjudgement{\ltimapsto{\ltiClosureCache{1}}
                                 {\ltiClosureID{}}
                                 {\ltiClosureCacheVal
                                  {\ltiFuel{}-1}
                                  {\ltiClosureElab{}}}}
...
\begin{figure}
  ...
  \begin{mathpar}
    \infer[ElabDriver]
    {
     \ltitSstkjudgement{\ltiEmptyClosureCache}
                       {\ltiEmptyEnv}
                       {\ltiE{1}}
                       {\ltiT{}}
                       {\ltiClosureCache{}}
  ...
  \begin{array}{llll}
    ...
    \ltielimClosalign{\ltiClosureCache{}}
                     ...
                     {\ltifuntparaminterface{\ova{\ltitvar{}}}
                                            ...
                                            {\ltielimClosLHS{\ltiClosureCache{}}{\ltiE{}}}}
                     \\
                     % if SC is never exercised, the metafunction will become stuck because \ltiF is an untyped lambda
    \ltielimClosalign{\ltiClosureCache{}}
                     {\ltiufunelab{\ltiufunelabentry{\ltiClosureID{}}}
                                  {\ltivar{}}
                                  {\ltiE{}}}
...
\begin{figure}
  \begin{mathpar}
    ...
    \infer [CG-Fun]
    {
    \text{TODO erase SC's in recursive calls}
    \\
