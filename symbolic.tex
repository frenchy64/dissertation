...
In \chapref{chapter:symbolic:directed-lti}
...
\begin{figure}
  \begin{mathpar}
    ...
    \infer [(I-Abs)]
    { 
    \ltitjudgement{\ltiEnv{},\hastype{\ltivar{}}{\ltiT{}}}
                  {\ltiE{}}
                  {\ltiS{}}
    }
    {
    ...
    {}
    {
    \ltiisubtype{\ltiBot}{\ltiT{}}
    }

    \infer [(S-Top)]
    {}
    {
    \ltiisubtype{\ltiT{}}{\ltiTop}
    }

    \infer [(S-Var)]
    {}
    {
    \ltiisubtype{\ltitvar{}}{\ltitvar{}}
    }
    ...
    {
    \ltiisubtype{\ltiRec{\hastype{\ltivar{1}}{\ltiT{1}}, ..., \hastype{\ltivar{n}}{\ltiT{n}},
    ...
    \infer [(S-Fun)]
    {
    \ltiisubtype{\ltiT{1}}{\ltiTp{1}}
    \\
    \ltiisubtype{\ltiT{2}}{\ltiTp{2}}
    }
    {
    \ltiisubtype{\ltiArrowMono{\ltiTp{1}}{\ltiT{2}}}
                {\ltiArrowMono{\ltiT{1}}{\ltiTp{2}}}
    }
  \end{mathpar}
...
\end{array}
$$
\caption{Monomorphic Internal Language Extensions for Symbolic Closure Types,
  where $\ltinat{} \in \mathbb{N}$.
  }
  \label{symbolic:figure:internal-language-syntax-extension}
\end{figure}

We extend the internal language to support symbolic closure types.
\figref{symbolic:figure:internal-language-syntax-extension}
shows our syntax extensions. We allow unannotated functions
...
\begin{figure}
  \begin{mathpar}
    ...
    \infer [(I-UApp)]
    {
    \ltitfjudgement{\ltiFuel{1}}
                   {\ltiEnv{}}{\ltiF{}}
                   {\ltiClosure{\ltiEnvp{}}{\ltiufun{\ltivar{}}{\ltiEp{}}}}
                   {\ltiFuel{2}}
                  \\\\
    \ltitfjudgement{\ltiFuel{2}}
                  {\ltiEnv{}}
                  {\ltiE{}}
                  {\ltiS{}}
                  {\ltiFuel{3}}
                  \\\\
    \ltiifsubtype{\ltiFuel{3}}
                 {\ltiClosure{\ltiEnvp{}}{\ltiufun{\ltivar{}}{\ltiEp{}}}}
                 {\ltiArrow{\ltiS{}}{}{\ltiT{}}}
                 {\ltiFuel{4}}
    }
  ...
  \end{mathpar}
  \caption{Symbolic Closure Type Extensions to Type System for Monomorphic Internal Language:
  \ltitfjudgement{\ltiFuel{}}
                 {\ltiEnv{}}
                 {\ltiE{}}
                 {\ltiT{}}
  ...
  (abbreviated
   \ltitjudgement{\ltiEnv{}}
                 ...
                 \ltiisubtype{\ltiT{}}{\ltiS{}}
                 when fuel
                 propagates left-to-right through its premises
                 like \textsc{I-UApp})
                 }
  \label{symbolic:figure:internal-language-type-system-extension}
\end{figure}

\figref{symbolic:figure:internal-language-type-system-extension}
...
\begin{figure}
  \begin{mathpar}
    ...
    \infer[]
    {
    \lticsubtype{\ltiT{1}}{\ltiT{2}}
    \\
    \lticsubtype{\ltiT{2}}{\ltiT{3}}
    }
    {\lticsubtype{\ltiT{1}}{\ltiT{2}}}
    ...
    \infer[]
    {
    \lticsubtype{\ltiT{1}}{\ltiTp{1}}
    \\
    ...
    \\
    \lticsubtype{\ltiT{n}}{\ltiTp{n}}
    }
    {
    \lticsubtype{\ltiRec{\hastype{\ltivar{1}}{\ltiT{1}},...,\hastype{\ltivar{n}}{\ltiT{n}}}}
                {\ltiRec{\hastype{\ltivar{1}}{\ltiTp{1}},...,\hastype{\ltivar{n}}{\ltiTp{n}}}}
    }

    \infer[]
    {
    \lticsubtypeinv{\ltiT{1}}{\ltiTp{1}}
    \\
    \lticsubtype{\ltiT{2}}{\ltiTp{2}}
    }
    {
    \lticsubtype{\ltiArrowMono{\ltiTp{1}}{\ltiT{2}}}
                {\ltiArrowMono{\ltiT{1}}{\ltiTp{2}}}
    }
    ...
    \infer[]
    {
    \ltitjudgement{\ltiEnv{},\hastype{\ltivar{}}{\ltiSyn{\ltiT{}}}}
                 {\ltiE{}}
                 {\ltiChk{\ltiS{}}}
    }
    {
    \lticsubtype{\ltiSyn{\ltiClosure{\ltiEnv{}}{\ltiufun{\ltivar{}}{\ltiE{}}}}}
                {\ltiSyn{\ltiArrowMono{\ltiChk{\ltiT{}}}{\ltiChk{\ltiS{}}}}}
    }

  \end{mathpar}
  \caption{Subtyping for colored types
  \lticsubtype{\ltiT{}}{\ltiS{}}.
  The upside-down $\leq$ relation 
  is defined like $\leq$, except with inverted colors.
...
\begin{figure}
  \begin{mathpar}
    ...
    {
    \lticjudgement{\ltiEnv{}}{\ltivar{}}{\ltiSyn{\ltiT{}}}
    }
    ...
    \infer[(C-Abs)]
    {
    \lticjudgement{\ltiEnv{}, \hastype{\ltivar{}}{\ltiSyn{\ltiT{}}}}
                  {\ltiE{}}
                  {\ltiS{}}
    }
    {
    \lticjudgement{\ltiEnv{}}
                  {\ltifunmono{\ltivar{}}{\ltiT{}}{\ltiE{}}}
                  {\ltiSyn{\ltiArrowMono{\ltiT{}}{\ltiSynChk{\ltiS{}}}}}
    }
    ...
    \lticjudgement{\ltiEnv{}}
                  {\ltiF{}}
                  {\ltiChk{\ltiArrowMono{\ltiSyn{\ltiS{}}}{\ltiSyn{\ltiT{}}}}}
                  \\
    \lticjudgement{\ltiEnv{}}
                  {\ltiE{}}
                  {\ltiSp{}}
...
\begin{figure}
  \begin{mathpar}
    ...
    {
    \ltiisubtype{\ltiArrow{\ltiTp{1}}{\overline{\ltitvar{}}}{\ltiT{2}}}
...
\begin{figure}
  \begin{mathpar}
    \infer [($\text{C-AbsPoly}_{tp}$)]
    {
    \lticjudgement{\ltiEnv{}, \ltiSyn{\ova{\ltitvar{}}}, \hastype{\ltivar{}}{\ltiSyn{\ltiT{}}}}
                  {\ltiE{}}
                  {\ltiS{}}
    }
    {
    ...
    \infer [($\text{C-AppPoly}_{tp}$)]
    {
    \lticjudgement{\ltiEnv{}}
                  {\ltiF{}}
                  {\ltiChk{\ltiArrow{\ltiSyn{\ltiS{}}}{\overline{\ltitvar{}}}{\ltiSyn{\ltiT{}}}}}
                 \\
    \lticjudgement{\ltiEnv{}}
                  {\ltiE{}}
                  {\ltireplace{\overline{\ltiR{}}}{\overline{\ltitvar{}}}{\ltiChk{\ltiS{}}}}
    }
    {
    \lticjudgement{\ltiEnv{}}
                  {\ltiappinst{\ltiF{}}{\overline{\ltiR{}}}{\ltiE{}}}
                  {\ltireplace{\overline{\ltiR{}}}{\overline{\ltitvar{}}}{\ltiSyn{\ltiT{}}}}
                  }
