...
Similar performance issues have infamously arisen in ML, summarized
by Mairson~\cite{Mairson:1989}, whose work provided
the final piece to prove that the problem of ML type-checking is \textsc{DExpTime}-complete.
While Mairson ingeniously encoded 
