...
\subsection{Symbolic Closure Metatheory Conjectures}
...
Unfortunately, this requires that SCL distinguishes between a type error
and running out of fuel, which would significantly complicate the model.
One way this might be able to be achieved is this based on a technique for
...
Then, running out of fuel can be recognized by a derivation ending
in a symbolic reduction rule with zero fuel.
