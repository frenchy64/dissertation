...
%Typed Clojure was designed in 2012, and Clojure has seen several new runtime
%features since then. One feature, transducers, is a function-based protocol
%for efficiently running processing pipelines for data sources such as lazy
%or eager sequences, and asynchronous channels.
