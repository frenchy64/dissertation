\subsection{Overview of Typed Clojure}

\label{sec:overview}

We now begin a tour of the central features of Typed Clojure.
%beginning with Clojure itself.
Our presentation
...
%before studying the core features in detail in \secref{sec:formal}.
...
%
%\subsubsection{HMaps and multimethods, joined at the hip}
%
...
%%
%Dispatch on multiple arguments is beyond the scope of this section,
