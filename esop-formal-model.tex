...
\subsection{A Formal Model of Typed Clojure}
\label{sec:formal}
...
%\end{array}
  ...
  \end{mathpar}
  \caption{Select core subtyping rules}
...
given as \figref{main:figure:othertypingrules}. 
...
\figref{main:figure:subtyping} presents select rules.
