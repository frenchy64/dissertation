...
\begin{tikzpicture}[remember picture, overlay,
  ...
  \coordinate (Start3) at (e);
  \coordinate (End3) at (f);
  \draw[->,bend right=-45](Start1.south) to (End1.east);
  \draw[->,bend right=-45](Start2.east) to (End2.north east);
  \draw[->,bend right=-45](Start3.east) to (End3.north east);
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay,
  ...
  \coordinate (Start2) at (c);
  \coordinate (End2) at (d);
  \draw[blue,->,bend right=-20](Start1.south) to (End1.east);
...
\begin{tikzpicture}[remember picture, overlay,
  ...
  \draw[blue,->,bend left=-20](D) to (E);
  \draw[blue,->,bend right=-20](E) to (F);
