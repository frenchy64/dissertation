...
\begin{figure}
  \begin{mathpar}
    ...
    \infer [(W-app)]
    {
    \ltijudgement%{\ltiArrow{\ltiWild{}}{}{\ltiP{}}}
                 {\ltiWild{}}
                 {\ltiEnv{}}{\ltiF{}}
                 {\ltiT{}}
                 \\
...
\begin{figure}
  ...
  %{\inferrule* [Left=Foo]
  % {\inferrule* [Right=Bar, leftskip=2em,rightskip=2em,vdots=1.5em]
  %  {a \\ a \\\\ bb \\ cc \\ dd}
  %  {ee}
  %  \\ ff \\ gg}
  % {hh}
